...
/**
 * This is the item provider adapter for a {@link org.modelversioning.emfprofile.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationItemProvider extends EOperationItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_position_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_position_feature", "_UI_Operation_type"),
				 EMFProfilePackage.Literals.OPERATION__POSITION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EMFProfilePackage.Literals.OPERATION__BODY,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Joinpoint feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	protected void addJoinpointPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_joinpoint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_joinpoint_feature", "_UI_Operation_type"),
				 EMFProfilePackage.Literals.OPERATION__JOINPOINT,
				 true,
				 false,
				 true,
				 null,
				...
				public Collection<?> getChoiceOfValues(Object object) {
					...
					Stereotype stereotype = (Stereotype) operation.eContainer();
					List<EOperation> joinpoints = new ArrayList<EOperation>();
					for(Extension extension : stereotype.getAllExtensions()){
						joinpoints.addAll(extension.getTarget().getEOperations());
					}
					return joinpoints;
				}
			});
