	...
	protected void addConstraintsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Extension_constraints_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Extension_constraints_feature", "_UI_Extension_type"),
				 EMFProfilePackage.Literals.EXTENSION__CONSTRAINTS,
				 true,
				 false,
				 false,
