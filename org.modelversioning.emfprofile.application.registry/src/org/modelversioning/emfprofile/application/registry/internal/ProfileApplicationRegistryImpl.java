...
public class ProfileApplicationRegistryImpl implements
	...
	@Override
	public StereotypeApplication getStereotypeApplication(String modelId, EObject eObject, String stereotypeId) {
		ProfileApplicationManager pam = modelledResourceProfilesApplicationsManagerMap.get(modelId);
		if(pam == null)
			return null;
		for (ProfileApplicationDecorator pad : pam.getProfileApplications()) {
			StereotypeApplication stereotypeApplication = pad.getStereotypeApplication(eObject, stereotypeId);
