...
public interface ProfileApplicationRegistry {
	...
	/**
	 * Checks if the given model element has a StereotypeApplication of the given Stereotype
	 * and returns it.
	 * @param modelID The string identification of the modelled resource.
	 * @param eObject The model element to check.
	 * @param stereotypeID The URI of the Stereotype to check for.
	 * @return
	 */
	StereotypeApplication getStereotypeApplication(String modelId, EObject eObject, String stereotypeId);
