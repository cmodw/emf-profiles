...
public class EMFProfileValidator extends EObjectValidator {
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case EMFProfilePackage.OPERATION:
				return validateOperation((Operation)value, diagnostics, context);
			case EMFProfilePackage.POSITION:
	...
	public boolean validateOperation(Operation operation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateOperation_joinpointTargetMustBeInExtendedClass(operation, diagnostics, context);
		return result;
	}

	/**
	 * The cached validation expression for the joinpointTargetMustBeInExtendedClass constraint of '<em>Operation</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String OPERATION__JOINPOINT_TARGET_MUST_BE_IN_EXTENDED_CLASS__EEXPRESSION = "self.joinpoint->notEmpty() implies self.eContainingClass.oclAsType(emfprofile::Stereotype).getAllExtensions()->exists(extension : Extension | extension.target.eOperations->exists(eo | eo = self.joinpoint))";

	/**
	 * Validates the joinpointTargetMustBeInExtendedClass constraint of '<em>Operation</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateOperation_joinpointTargetMustBeInExtendedClass(Operation operation, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(EMFProfilePackage.Literals.OPERATION,
				 operation,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL",
				 "joinpointTargetMustBeInExtendedClass",
				 OPERATION__JOINPOINT_TARGET_MUST_BE_IN_EXTENDED_CLASS__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
