...
public class EMFProfilePackageImpl extends EPackageImpl implements EMFProfilePackage {
	 ...
	 * @generated
	 */
	public EAttribute getExtension_Constraints() {
	 ...
	 * @generated
	 */
	public EAttribute getOperation_Position() {
	 ...
	 * @generated
	 */
	public EReference getOperation_Joinpoint() {
	...
	public void createPackageContents() {
		...
		createEAttribute(extensionEClass, EXTENSION__CONSTRAINTS);
		...
		createEAttribute(operationEClass, OPERATION__POSITION);
		createEAttribute(operationEClass, OPERATION__BODY);
		createEReference(operationEClass, OPERATION__JOINPOINT);
	...
	public void initializePackageContents() {
		...
		addEOperation(stereotypeEClass, this.getOperation(), "getOperations", 0, -1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(stereotypeEClass, this.getOperation(), "getOperation", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getExtension_Constraints(), ecorePackage.getEString(), "constraints", "", 0, 1, Extension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getOperation_Position(), this.getPosition(), "position", "Around", 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getOperation_Joinpoint(), theEcorePackage.getEOperation(), null, "joinpoint", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(positionEEnum, Position.class, "Position");
		addEEnumLiteral(positionEEnum, Position.BEFORE);
		addEEnumLiteral(positionEEnum, Position.AROUND);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (operationEClass, 
		   source, 
		   new String[] {
			 "constraints", "joinpointTargetMustBeInExtendedClass"
		   });
	}
	...
	protected void createOCLAnnotations() {
		...
		addAnnotation
		  (operationEClass, 
		   source, 
		   new String[] {
			 "joinpointTargetMustBeInExtendedClass", "self.joinpoint->notEmpty() implies self.eContainingClass.oclAsType(emfprofile::Stereotype).getAllExtensions()->exists(extension : Extension | extension.target.eOperations->exists(eo | eo = self.joinpoint))"
		   });
	}
