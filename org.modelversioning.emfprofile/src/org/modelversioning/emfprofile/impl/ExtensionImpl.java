 ...
 *   <li>{@link org.modelversioning.emfprofile.impl.ExtensionImpl#getConstraints <em>Constraints</em>}</li>
...
public class ExtensionImpl extends EObjectImpl implements Extension {
	...
	public void setConstraints(String newConstraints) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EMFProfilePackage.EXTENSION__CONSTRAINTS, oldConstraints, constraints));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EMFProfilePackage.EXTENSION__CONSTRAINTS:
