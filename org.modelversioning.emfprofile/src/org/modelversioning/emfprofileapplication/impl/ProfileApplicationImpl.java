...
public class ProfileApplicationImpl extends EObjectImpl implements
	 ...
	 * @generated NOT
	 */
	public StereotypeApplication getStereotypeApplication(EObject eObject, String stereotypeId) {
		for (StereotypeApplication stereotypeApplication : getStereotypeApplications(eObject)) {
			String uri = stereotypeApplication.eClass().getEPackage().getNsURI()+stereotypeApplication.eClass().getName();
			if (uri.equals(stereotypeId)) {
