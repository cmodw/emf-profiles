...
public class EMFProfileApplicationFactoryImpl extends EFactoryImpl implements EMFProfileApplicationFactory {
	...
	public static EMFProfileApplicationFactory init() {
		try {
			EMFProfileApplicationFactory theEMFProfileApplicationFactory = (EMFProfileApplicationFactory)EPackage.Registry.INSTANCE.getEFactory(EMFProfileApplicationPackage.eNS_URI);
