...
public class EMFProfileApplicationPackageImpl extends EPackageImpl implements EMFProfileApplicationPackage {
	...
	public void initializePackageContents() {
		...
		op = addEOperation(profileApplicationEClass, this.getStereotypeApplication(), "getStereotypeApplication", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEObject(), "eObject", 1, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "stereotypeId", 1, 1, IS_UNIQUE, IS_ORDERED);
