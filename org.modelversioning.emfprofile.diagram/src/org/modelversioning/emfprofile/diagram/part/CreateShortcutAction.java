...
public class CreateShortcutAction extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (dialog.open() == Dialog.OK) {
			...
			EPackage ePackage = EPackage.Registry.INSTANCE.getEPackage(stringURI);

			ShortcutCreationWizard wizard = new ShortcutCreationWizard(ePackage, view, editingDomain);
