...
public class EMFProfileDiagramContentInitializer {
	...
	private void createProfile_1000Children(View view) {
		Collection childNodeDescriptors = EMFProfileDiagramUpdater.getProfile_1000SemanticChildren(view);
	...
	private void createStereotype_2006Children(View view) {
		...
		myLinkDescriptors.addAll(EMFProfileDiagramUpdater.getStereotype_2006OutgoingLinks(view));
		createStereotypeTaggedValueComp_7008Children(getCompartment(view, StereotypeTaggedValueCompEditPart.VISUAL_ID));
		createStereotypeOperationComp_7009Children(getCompartment(view, StereotypeMethodCompEditPart.VISUAL_ID));
	...
	private void createEClass_2002Children(View view) {
		myDomain2NotationMap.put(view.getElement(), view);
		myLinkDescriptors.addAll(EMFProfileDiagramUpdater.getEClass_2002OutgoingLinks(view));
	...
	private void createEPackage_2003Children(View view) {
		myDomain2NotationMap.put(view.getElement(), view);
		myLinkDescriptors.addAll(EMFProfileDiagramUpdater.getEPackage_2003OutgoingLinks(view));
	...
	private void createEEnum_2004Children(View view) {
		myDomain2NotationMap.put(view.getElement(), view);
		myLinkDescriptors.addAll(EMFProfileDiagramUpdater.getEEnum_2004OutgoingLinks(view));
	...
	private void createEDataType_2005Children(View view) {
		myDomain2NotationMap.put(view.getElement(), view);
		myLinkDescriptors.addAll(EMFProfileDiagramUpdater.getEDataType_2005OutgoingLinks(view));
	...
	private void createEAttribute_3001Children(View view) {
		myDomain2NotationMap.put(view.getElement(), view);
		myLinkDescriptors.addAll(EMFProfileDiagramUpdater.getEAttribute_3001OutgoingLinks(view));
	...
	* @generated
	*/
	private void createOperation_3007Children(View view) {
		myDomain2NotationMap.put(view.getElement(), view);
		myLinkDescriptors.addAll(EMFProfileDiagramUpdater.getOperation_3007OutgoingLinks(view));
	...
	private void createEAttribute_3004Children(View view) {
		myDomain2NotationMap.put(view.getElement(), view);
		myLinkDescriptors.addAll(EMFProfileDiagramUpdater.getEAttribute_3004OutgoingLinks(view));
	...
	private void createEOperation_3005Children(View view) {
		myDomain2NotationMap.put(view.getElement(), view);
		myLinkDescriptors.addAll(EMFProfileDiagramUpdater.getEOperation_3005OutgoingLinks(view));
	...
	private void createEClass_3002Children(View view) {
		myDomain2NotationMap.put(view.getElement(), view);
		myLinkDescriptors.addAll(EMFProfileDiagramUpdater.getEClass_3002OutgoingLinks(view));
	...
	private void createEEnumLiteral_3003Children(View view) {
		myDomain2NotationMap.put(view.getElement(), view);
		myLinkDescriptors.addAll(EMFProfileDiagramUpdater.getEEnumLiteral_3003OutgoingLinks(view));
	...
	* @generated
	*/
	private void createStereotypeOperationComp_7009Children(View view) {
		Collection childNodeDescriptors = EMFProfileDiagramUpdater
				.getStereotypeOperationComp_7009SemanticChildren(view);
		for (Iterator it = childNodeDescriptors.iterator(); it.hasNext();) {
			createNode(view, (EMFProfileNodeDescriptor) it.next());
		}
	}
	...
	private void createEClassAttributes_7004Children(View view) {
		Collection childNodeDescriptors = EMFProfileDiagramUpdater.getEClassAttributes_7004SemanticChildren(view);
		for (Iterator it = childNodeDescriptors.iterator(); it.hasNext();) {
			createNode(view, (EMFProfileNodeDescriptor) it.next());
		}
	}
	...
	private void createEClassOperations_7005Children(View view) {
		Collection childNodeDescriptors = EMFProfileDiagramUpdater.getEClassOperations_7005SemanticChildren(view);
		for (Iterator it = childNodeDescriptors.iterator(); it.hasNext();) {
			createNode(view, (EMFProfileNodeDescriptor) it.next());
		}
	}
	...
	private void createEPackageContents_7002Children(View view) {
		Collection childNodeDescriptors = EMFProfileDiagramUpdater.getEPackageContents_7002SemanticChildren(view);
		for (Iterator it = childNodeDescriptors.iterator(); it.hasNext();) {
			createNode(view, (EMFProfileNodeDescriptor) it.next());
		}
	}
	...
	private void createEClassAttributes_7006Children(View view) {
		Collection childNodeDescriptors = EMFProfileDiagramUpdater.getEClassAttributes_7006SemanticChildren(view);
		for (Iterator it = childNodeDescriptors.iterator(); it.hasNext();) {
			createNode(view, (EMFProfileNodeDescriptor) it.next());
		}
	}
	...
	private void createEClassOperations_7007Children(View view) {
		Collection childNodeDescriptors = EMFProfileDiagramUpdater.getEClassOperations_7007SemanticChildren(view);
		for (Iterator it = childNodeDescriptors.iterator(); it.hasNext();) {
			createNode(view, (EMFProfileNodeDescriptor) it.next());
		}
	}
	...
	private void createEEnumLiterals_7003Children(View view) {
		Collection childNodeDescriptors = EMFProfileDiagramUpdater.getEEnumLiterals_7003SemanticChildren(view);
		for (Iterator it = childNodeDescriptors.iterator(); it.hasNext();) {
			createNode(view, (EMFProfileNodeDescriptor) it.next());
		}
	}
	...
	private void createNode(View parentView, EMFProfileNodeDescriptor nodeDescriptor) {
		final String nodeType = EMFProfileVisualIDRegistry.getType(nodeDescriptor.getVisualID());
		...
		case OperationEditPart.VISUAL_ID:
			createOperation_3007Children(node);
			return;
	...
	private void createLinks(Diagram diagram) {
		for (boolean continueLinkCreation = true; continueLinkCreation;) {
			...
			for (Iterator it = myLinkDescriptors.iterator(); it.hasNext();) {
				...
				final String linkType = EMFProfileVisualIDRegistry.getType(nextLinkDescriptor.getVisualID());
				Edge edge = ViewService.getInstance().createEdge(nextLinkDescriptor.getSemanticAdapter(), diagram,
						linkType, ViewUtil.APPEND, true, EMFProfileDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT);
				if (edge != null) {
					...
					case ExtensionEditPart.VISUAL_ID:
						additionalDescriptors.addAll(EMFProfileDiagramUpdater.getExtension_4005OutgoingLinks(edge));
						break;
					case EReferenceEditPart.VISUAL_ID:
						additionalDescriptors.addAll(EMFProfileDiagramUpdater.getEReference_4003OutgoingLinks(edge));
						break;
					}
				}
			}
