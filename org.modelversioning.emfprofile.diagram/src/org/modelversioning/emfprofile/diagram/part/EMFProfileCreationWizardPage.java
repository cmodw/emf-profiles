...
public class EMFProfileCreationWizardPage extends WizardNewFileCreationPage {
	...
	public void createControl(Composite parent) {
		...
		setFileName(
				EMFProfileDiagramEditorUtil.getUniqueFileName(getContainerFullPath(), getFileName(), getExtension()));
	...
	protected boolean validatePage() {
		...
		if (extension != null && !getFilePath().toString().endsWith("." + extension)) {
			setErrorMessage(NLS.bind(Messages.EMFProfileCreationWizardPageExtensionError, extension));
			return false;
		}
		return true;
	}
