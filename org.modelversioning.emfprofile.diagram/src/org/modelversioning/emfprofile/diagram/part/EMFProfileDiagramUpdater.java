...
public class EMFProfileDiagramUpdater {
	...
	public static List<EMFProfileNodeDescriptor> getSemanticChildren(View view) {
		...
		case StereotypeMethodCompEditPart.VISUAL_ID:
			return getStereotypeOperationComp_7009SemanticChildren(view);
	...
	public static List<EMFProfileNodeDescriptor> getProfile_1000SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getEClassifiers().iterator(); it.hasNext();) {
			...
			int visualID = EMFProfileVisualIDRegistry.getNodeVisualID(view, childElement);
	...
	* @generated
	*/
	public static List<EMFProfileNodeDescriptor> getStereotypeOperationComp_7009SemanticChildren(View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.emptyList();
		}
		View containerView = (View) view.eContainer();
	...
	* @generated
	*/
	public static List<EMFProfileLinkDescriptor> getOperation_3007ContainedLinks(View view) {
		return Collections.emptyList();
	}
	...
	public static List<EMFProfileLinkDescriptor> getStereotype_2006IncomingLinks(View view) {
		...
		LinkedList<EMFProfileLinkDescriptor> result = new LinkedList<EMFProfileLinkDescriptor>();
		result.addAll(getIncomingTypeModelFacetLinks_Extension_4005(modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_EClass_ESuperTypes_4002(modelElement, crossReferences));
	...
	* @generated
	*/
	public static List<EMFProfileLinkDescriptor> getOperation_3007IncomingLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<EMFProfileLinkDescriptor> getOperation_3007OutgoingLinks(View view) {
		return Collections.emptyList();
	}
	...
	private static Collection<EMFProfileLinkDescriptor> getContainedTypeModelFacetLinks_Extension_4005(
		...
		LinkedList<EMFProfileLinkDescriptor> result = new LinkedList<EMFProfileLinkDescriptor>();
		for (Iterator<?> links = container.getExtensions().iterator(); links.hasNext();) {
			EObject linkObject = (EObject) links.next();
			if (false == linkObject instanceof Extension) {
				continue;
			}
			Extension link = (Extension) linkObject;
			if (ExtensionEditPart.VISUAL_ID != EMFProfileVisualIDRegistry.getLinkWithClassVisualID(link)) {
				continue;
			}
			EClass dst = link.getTarget();
			Stereotype src = link.getSource();
			result.add(new EMFProfileLinkDescriptor(src, dst, link, EMFProfileElementTypes.Extension_4005,
	...
	private static Collection<EMFProfileLinkDescriptor> getContainedTypeModelFacetLinks_EReference_4003(
		...
		for (Iterator<?> links = container.getEStructuralFeatures().iterator(); links.hasNext();) {
			...
			if (EReferenceEditPart.VISUAL_ID != EMFProfileVisualIDRegistry.getLinkWithClassVisualID(link)) {
				continue;
			}
			EClassifier dst = link.getEType();
			result.add(new EMFProfileLinkDescriptor(container, dst, link, EMFProfileElementTypes.EReference_4003,
	 ...
	 * @generated
	 */
	private static Collection<EMFProfileLinkDescriptor> getIncomingTypeModelFacetLinks_Extension_4005(EClass target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<EMFProfileLinkDescriptor> result = new LinkedList<EMFProfileLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences.get(target);
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() != EMFProfilePackage.eINSTANCE.getExtension_Target()
			...
			Stereotype src = link.getSource();
			result.add(new EMFProfileLinkDescriptor(src, target, link, EMFProfileElementTypes.Extension_4005,
					ExtensionEditPart.VISUAL_ID));
		}
		return result;
	}
	...
	private static Collection<EMFProfileLinkDescriptor> getIncomingFeatureModelFacetLinks_EClass_ESuperTypes_4002(
			EClass target, Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<EMFProfileLinkDescriptor> result = new LinkedList<EMFProfileLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences.get(target);
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == EcorePackage.eINSTANCE.getEClass_ESuperTypes()) {
				result.add(new EMFProfileLinkDescriptor(setting.getEObject(), target,
						EMFProfileElementTypes.EClassESuperTypes_4002, EClassESuperTypesEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	...
	private static Collection<EMFProfileLinkDescriptor> getIncomingTypeModelFacetLinks_EReference_4003(
			EClassifier target, Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<EMFProfileLinkDescriptor> result = new LinkedList<EMFProfileLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences.get(target);
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() != EcorePackage.eINSTANCE.getETypedElement_EType()
			...
			result.add(new EMFProfileLinkDescriptor(container, target, link, EMFProfileElementTypes.EReference_4003,
					EReferenceEditPart.VISUAL_ID));
	...
	private static Collection<EMFProfileLinkDescriptor> getOutgoingFeatureModelFacetLinks_EClass_ESuperTypes_4002(
		...
		for (Iterator<?> destinations = source.getESuperTypes().iterator(); destinations.hasNext();) {
			...
			result.add(new EMFProfileLinkDescriptor(source, destination, EMFProfileElementTypes.EClassESuperTypes_4002,
	...
	*/
	public static final DiagramUpdater TYPED_INSTANCE = new DiagramUpdater() {
		...
		*/
		...
		public List<EMFProfileNodeDescriptor> getSemanticChildren(View view) {
			return EMFProfileDiagramUpdater.getSemanticChildren(view);
		}
		...
		*/
		...
		public List<EMFProfileLinkDescriptor> getContainedLinks(View view) {
			return EMFProfileDiagramUpdater.getContainedLinks(view);
		}
		...
		*/
		...
		public List<EMFProfileLinkDescriptor> getIncomingLinks(View view) {
			return EMFProfileDiagramUpdater.getIncomingLinks(view);
		}
		...
		*/
		...
		public List<EMFProfileLinkDescriptor> getOutgoingLinks(View view) {
			return EMFProfileDiagramUpdater.getOutgoingLinks(view);
		}
	};
