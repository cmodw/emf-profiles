...
public class EMFProfileInitDiagramFileAction implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new EMFProfileNewDiagramFileWizard(resource.getURI(), diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle, ProfileEditPart.MODEL_ID));
		EMFProfileDiagramEditorUtil.runWizard(getShell(), wizard, "InitDiagramFile"); //$NON-NLS-1$
	}
}
