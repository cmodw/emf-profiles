...
public class EMFProfileVisualIDRegistry {
	...
	public static int getVisualID(View view) {
		...
		return org.modelversioning.emfprofile.diagram.part.EMFProfileVisualIDRegistry.getVisualID(view.getType());
	}
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (EMFProfilePackage.eINSTANCE.getProfile().isSuperTypeOf(domainElement.eClass())
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		if (!ProfileEditPart.MODEL_ID.equals(containerModelID) && !"ecore".equals(containerModelID)) { //$NON-NLS-1$
			return -1;
		}
		...
		case ProfileEditPart.VISUAL_ID:
			...
			if (EcorePackage.eINSTANCE.getEDataType().isSuperTypeOf(domainElement.eClass())
		...
		case StereotypeMethodCompEditPart.VISUAL_ID:
			if (EMFProfilePackage.eINSTANCE.getOperation().isSuperTypeOf(domainElement.eClass())) {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case StereotypeEditPart.VISUAL_ID:
			...
			if (StereotypeMethodCompEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
	...
	private static boolean isEDataType_2005(EDataType domainElement) {
		Object result = EMFProfileOCLFactory.getExpression(0, EcorePackage.eINSTANCE.getEDataType(), null)
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		*/
		...
		public int getVisualID(View view) {
			return org.modelversioning.emfprofile.diagram.part.EMFProfileVisualIDRegistry.getVisualID(view);
		}
		...
		*/
		...
		public String getModelID(View view) {
			return org.modelversioning.emfprofile.diagram.part.EMFProfileVisualIDRegistry.getModelID(view);
		}
		...
		*/
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return org.modelversioning.emfprofile.diagram.part.EMFProfileVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		}
