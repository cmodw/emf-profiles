...
public class EMFProfileOCLFactory {
	...
	*/
	...
	protected EMFProfileOCLFactory() {
		...
		this.expressionBodies = new String[] { "not oclIsKindOf(ecore::EEnum)", //$NON-NLS-1$
	...
	* @generated
	*/
	private static EMFProfileOCLFactory getInstance() {
		EMFProfileOCLFactory instance = EMFProfileDiagramEditorPlugin.getInstance().getEMFProfileOCLFactory();
		if (instance == null) {
			EMFProfileDiagramEditorPlugin.getInstance().setEMFProfileOCLFactory(instance = new EMFProfileOCLFactory());
		}
		return instance;
	}
	...
	*/
	 ...
	 * @generated
	 */
	public static EMFProfileAbstractExpression getExpression(int index, EClassifier context,
			Map<String, EClassifier> environment) {
		EMFProfileOCLFactory cached = getInstance();
