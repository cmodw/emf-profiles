...
public class EMFProfileParserProvider extends AbstractProvider implements IParserProvider {
	...
	private IParser getStereotypeName_5008Parser() {
		if (stereotypeName_5008Parser == null) {
			...
			EAttribute[] editableFeatures = new EAttribute[] { EcorePackage.eINSTANCE.getENamedElement_Name() };
	...
	*/
	...
	private IParser getExtensionLowerBoundUpperBound_6004Parser() {
		if (extensionLowerBoundUpperBound_6004Parser == null) {
			EAttribute[] features = new EAttribute[] { EMFProfilePackage.eINSTANCE.getExtension_LowerBound(),
	...
	private IParser getEReferenceLowerBoundUpperBound_6002Parser() {
		if (eReferenceLowerBoundUpperBound_6002Parser == null) {
			EAttribute[] features = new EAttribute[] { EcorePackage.eINSTANCE.getETypedElement_LowerBound(),
