 ...
 * @generated
 */
public class EClass2ItemSemanticEditPolicy extends EMFProfileBaseItemSemanticEditPolicy {
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (EMFProfileElementTypes.EClassESuperTypes_4002 == req.getElementType()) {
