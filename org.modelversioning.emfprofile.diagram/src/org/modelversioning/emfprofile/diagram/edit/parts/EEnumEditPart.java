...
public class EEnumEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EMFProfileVisualIDRegistry.getType(EEnumNameEditPart.VISUAL_ID));
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == EMFProfileElementTypes.EEnumLiteral_3003) {
				return getChildBySemanticHint(EMFProfileVisualIDRegistry.getType(EEnumLiteralsEditPart.VISUAL_ID));
			}
		}
