 ...
 * @generated
 */
public class EDataTypeInstanceClassNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new EMFProfileTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EMFProfileParserProvider.getParser(EMFProfileElementTypes.EDataType_2005, getParserElement(),
					EMFProfileVisualIDRegistry.getType(
							org.modelversioning.emfprofile.diagram.edit.parts.EDataTypeInstanceClassNameEditPart.VISUAL_ID));
		}
		return parser;
	}
