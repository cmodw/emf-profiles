 ...
 * @generated
 */
public class ExtensionLowerBoundUpperBoundEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	...
	static {
		registerSnapBackPosition(
				EMFProfileVisualIDRegistry.getType(
						org.modelversioning.emfprofile.diagram.edit.parts.ExtensionLowerBoundUpperBoundEditPart.VISUAL_ID),
				new Point(10, 10));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EMFProfileParserProvider.getParser(EMFProfileElementTypes.Extension_4005, getParserElement(),
					EMFProfileVisualIDRegistry.getType(
							org.modelversioning.emfprofile.diagram.edit.parts.ExtensionLowerBoundUpperBoundEditPart.VISUAL_ID));
		}
		return parser;
