...
public class StereotypeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EMFProfileParserProvider.getParser(EMFProfileElementTypes.Stereotype_2006, getParserElement(),
					EMFProfileVisualIDRegistry.getType(
							org.modelversioning.emfprofile.diagram.edit.parts.StereotypeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
