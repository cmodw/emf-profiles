...
public class EPackageEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EMFProfileVisualIDRegistry.getType(EPackageNameEditPart.VISUAL_ID));
	}
	...
	public class PackageFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigurePackageLabelRectangle.setBorder(new MarginBorder(getMapMode().DPtoLP(5), getMapMode().DPtoLP(5),
			...
			this.add(fFigurePackageLabelRectangle, constraintFFigurePackageLabelRectangle);
			...
			layoutFFigurePackageLabelRectangle.setMinorAlignment(ToolbarLayout.ALIGN_TOPLEFT);

			layoutFFigurePackageLabelRectangle.setSpacing(5);
			layoutFFigurePackageLabelRectangle.setVertical(true);

			fFigurePackageLabelRectangle.setLayoutManager(layoutFFigurePackageLabelRectangle);
			...
			fFigurePackageLabelRectangle.setBackgroundColor(FFIGUREPACKAGELABELRECTANGLE_BACK);
			fFigurePackageLabelRectangle.setForegroundColor(ColorConstants.darkGray);
			...
			fFigurePackageBodyRectangle.setBackgroundColor(FFIGUREPACKAGEBODYRECTANGLE_BACK);
			fFigurePackageBodyRectangle.setForegroundColor(ColorConstants.darkGray);
	 ...
	 * @generated
	 */
	static final Color FFIGUREPACKAGELABELRECTANGLE_BACK = new Color(null, 211, 211, 211);

	/**
	 * @generated
	 */
	static final Color FFIGUREPACKAGEBODYRECTANGLE_BACK = new Color(null, 211, 211, 211);
