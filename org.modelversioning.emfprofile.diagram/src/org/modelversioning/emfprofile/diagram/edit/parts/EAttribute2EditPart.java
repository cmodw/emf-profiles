 ...
 * @generated
 */
public class EAttribute2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EAttribute2ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EMFProfileParserProvider.getParser(EMFProfileElementTypes.EAttribute_3004, getParserElement(),
