...
public class EReferenceLowerBoundUpperBoundEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	...
	static {
		registerSnapBackPosition(
				EMFProfileVisualIDRegistry.getType(
						org.modelversioning.emfprofile.diagram.edit.parts.EReferenceLowerBoundUpperBoundEditPart.VISUAL_ID),
				new Point(10, 10));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EMFProfileParserProvider.getParser(EMFProfileElementTypes.EReference_4003, getParserElement(),
					EMFProfileVisualIDRegistry.getType(
							org.modelversioning.emfprofile.diagram.edit.parts.EReferenceLowerBoundUpperBoundEditPart.VISUAL_ID));
		}
		return parser;
