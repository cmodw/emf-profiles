...
public class EClass2EditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EMFProfileVisualIDRegistry.getType(EClassName2EditPart.VISUAL_ID));
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == EMFProfileElementTypes.EAttribute_3004) {
				return getChildBySemanticHint(EMFProfileVisualIDRegistry.getType(EClassAttributes2EditPart.VISUAL_ID));
			}
			if (type == EMFProfileElementTypes.EOperation_3005) {
				return getChildBySemanticHint(EMFProfileVisualIDRegistry.getType(EClassOperations2EditPart.VISUAL_ID));
			}
		}
