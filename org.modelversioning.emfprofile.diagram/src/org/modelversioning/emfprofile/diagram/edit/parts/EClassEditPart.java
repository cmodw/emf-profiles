...
public class EClassEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EMFProfileVisualIDRegistry.getType(EClassNameEditPart.VISUAL_ID));
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == EMFProfileElementTypes.EAttribute_3004) {
				return getChildBySemanticHint(EMFProfileVisualIDRegistry.getType(EClassAttributesEditPart.VISUAL_ID));
			}
			if (type == EMFProfileElementTypes.EOperation_3005) {
				return getChildBySemanticHint(EMFProfileVisualIDRegistry.getType(EClassOperationsEditPart.VISUAL_ID));
			}
		}
