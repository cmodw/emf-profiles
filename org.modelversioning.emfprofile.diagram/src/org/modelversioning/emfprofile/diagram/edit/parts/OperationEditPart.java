...
import org.modelversioning.emfprofile.diagram.edit.policies.OperationItemSemanticEditPolicy;
...
public class OperationEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new EMFProfileTextNonResizableEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = EMFProfileParserProvider.getParser(EMFProfileElementTypes.Operation_3007, getParserElement(),
					EMFProfileVisualIDRegistry
							.getType(org.modelversioning.emfprofile.diagram.edit.parts.OperationEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, EMFProfileEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new OperationDisc();
	}

	/**
	 * @generated
	 */
	public class OperationDisc extends WrappingLabel {

		/**
		 * @generated
		 */
		public OperationDisc() {
			this.setText("");
		}
