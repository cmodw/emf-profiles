...
public class EClassESuperTypesReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return EMFProfileBaseItemSemanticEditPolicy.getLinkConstraints().canExistEClassESuperTypes_4002(getNewSource(),
				getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return EMFProfileBaseItemSemanticEditPolicy.getLinkConstraints().canExistEClassESuperTypes_4002(getOldSource(),
				getNewTarget());
	}
