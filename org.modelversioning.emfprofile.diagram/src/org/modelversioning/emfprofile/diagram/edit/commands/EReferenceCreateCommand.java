...
public class EReferenceCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return EMFProfileBaseItemSemanticEditPolicy.getLinkConstraints().canCreateEReference_4003(getSource(),
				getTarget());
	}
	 ...
	 * @generated
	 */
	protected void doConfigure(EReference newElement, IProgressMonitor monitor, IAdaptable info)
