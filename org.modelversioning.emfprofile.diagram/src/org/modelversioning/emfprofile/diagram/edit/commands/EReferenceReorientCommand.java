...
public class EReferenceReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return EMFProfileBaseItemSemanticEditPolicy.getLinkConstraints().canExistEReference_4003(getLink(),
				getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return EMFProfileBaseItemSemanticEditPolicy.getLinkConstraints().canExistEReference_4003(getLink(), source,
				getNewTarget());
	}
