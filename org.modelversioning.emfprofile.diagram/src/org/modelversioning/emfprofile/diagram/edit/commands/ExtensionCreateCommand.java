...
public class ExtensionCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return EMFProfileBaseItemSemanticEditPolicy.getLinkConstraints().canCreateExtension_4005(getContainer(),
				getSource(), getTarget());
	}
	 ...
	 * @generated
	 */
	protected void doConfigure(Extension newElement, IProgressMonitor monitor, IAdaptable info)
